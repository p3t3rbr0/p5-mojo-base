--
-- !Comment: Creation basic applications tables
--
...
CREATE UNIQUE INDEX `uid__users_idx` ON `users` (`uid`);
CREATE UNIQUE INDEX `email__users_idx` ON `users` (`email`);
CREATE UNIQUE INDEX `username__users_idx` ON `users` (`username`);
